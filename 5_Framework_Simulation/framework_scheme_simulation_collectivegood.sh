#!/bin/bash
#SBATCH --job-name=SR_CG
#SBATCH --output=../logs_Github/SR_CG.%A_%a.out # Output file (A is the job ID, a is the task ID)
#SBATCH --error=../logs_Github/SR_CG.%A_%a.err  # Error file
