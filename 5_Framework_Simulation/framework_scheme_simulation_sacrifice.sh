#!/bin/bash
#SBATCH --job-name=SR_S
#SBATCH --output=../logs_Github/SR_S.%A_%a.out # Output file (A is the job ID, a is the task ID)
#SBATCH --error=../logs_Github/SR_S.%A_%a.err  # Error file
