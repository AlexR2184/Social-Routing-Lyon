...
def main():
    ...
    run_num=101 # run_num ID for the full UC simulation

    social_days_number=1 # all 5 days in a week the users take the SR
    participation_rate1=0 # all users are participating in social routing scheme, all use SR.
...
#------------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------------
    file_path = os.path.join(cwd, "macro_output_fullUC_mean.pickle")
